...
from utils.utils import check_platform, install_requirements, silent_wrapper
...
def main():
            ...
            with gr.Tab("WebUI"):
                with gr.Row():
                    ...
                    new_interface = gr.Checkbox(
                        env.new_interface, label="使用新文生图界面(修改此项保存后需关闭脚本后手动重启)"
                    )
                height = gr.Slider(
    ...
    sanp.queue().launch(
        ...
        favicon_path="./files/webui/logo.png",
